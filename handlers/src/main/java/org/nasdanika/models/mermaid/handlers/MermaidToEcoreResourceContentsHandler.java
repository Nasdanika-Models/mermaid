...
public class MermaidToEcoreResourceContentsHandler implements ResourceContentsHandler<EPackage[]> {
	...
	public MermaidToEcoreResourceContentsHandler(Resource resource, ResourceContentsHandler<Document> docuentHandler) {
