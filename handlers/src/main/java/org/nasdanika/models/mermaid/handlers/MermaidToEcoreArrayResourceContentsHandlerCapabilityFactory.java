package org.nasdanika.models.mermaid.handlers;
...
public class MermaidToEcoreArrayResourceContentsHandlerCapabilityFactory extends ServiceCapabilityFactory<org.nasdanika.capability.emf.ResourceContentsHandler.Requirement, ResourceContentsHandler<EObject[]>> {
	...
	protected ResourceContentsHandler<EObject[]> createHandler(Resource resource, ResourceContentsHandler<Document> dh) {
		return new MermaidToEcoreResourceContentsHandler(resource, dh).adaptToEObjectArrayContentsHandler();
	}
