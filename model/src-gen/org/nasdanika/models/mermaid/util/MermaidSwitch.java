 ...
 * @generated
 */
public class MermaidSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case MermaidPackage.MERMAID_DIAGRAM: {
				MermaidDiagram mermaidDiagram = (MermaidDiagram)theEObject;
				T result = caseMermaidDiagram(mermaidDiagram);
				if (result == null) result = caseSlide(mermaidDiagram);
				if (result == null) result = caseDiagram(mermaidDiagram);
				if (result == null) result = caseDiagramElement(mermaidDiagram);
				if (result == null) result = caseNamedElement(mermaidDiagram);
				if (result == null) result = caseModelElement(mermaidDiagram);
				if (result == null) result = caseStringIdentity(mermaidDiagram);
				if (result == null) result = caseDocumented(mermaidDiagram);
				if (result == null) result = caseMarked(mermaidDiagram);
				if (result == null) result = caseReferrable(mermaidDiagram);
	 ...
	 * @generated
	 */
	public T caseMermaidDiagram(MermaidDiagram object) {
		return null;
	}
